...
class ViewPagerActivity : SimpleActivity(), ViewPager.OnPageChangeListener, ViewPagerFragment.FragmentListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        window.decorView.setBackgroundColor(if (config.blackBackground) getProperBackgroundColor() else android.graphics.Color.BLACK)
...
//        }
    ...
    private fun initContinue() {
        ...
        // Always black behind photos so blur background shows correctly
    ...
    private fun copyMoveTo(isCopyOperation: Boolean) {
        ...
        tryCopyMoveFilesTo(fileDirItems, isCopyOperation) {
            ...
            if (!isCopyOperation) {
                ...
                // Avança direto para o próximo vídeo sem esperar refresh
                runOnUiThread {
