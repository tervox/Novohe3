    ...
    private fun loadImage() {
        ...
        ensureBackgroundThread {
            ...
            activity?.runOnUiThread {
                when {
                    mMedium.isGIF() -> { loadGif(); isBlur = true }
                    mMedium.isSVG() -> loadSVG()
                    mMedium.isApng() -> { loadAPNG(); isBlur = true }
                    mMedium.isAvif() -> { loadAVIF(); isBlur = true }
                    else -> { loadBitmap(); isBlur = true }
                }
                if (isBlur && !context!!.config.blackBackground) {
                    binding.photoBlurBackground.visibility = android.view.View.VISIBLE
                    ...
                    binding.photoBlurBackground.visibility = android.view.View.GONE
                }
            }
        }
    }
